...
`,"getStyles"),v=(0,n.eW)(function(t,e){return(0,r.Mu)(t,e)},"drawRect"),w=(0,n.eW)(function(t,e){let i=t.append("circle").attr("cx",e.cx).attr("cy",e.cy).attr("class","face").attr("r",15).attr("stroke-width",2).attr("overflow","visible"),r=t.append("g");function a(t){let i=(0,s.Nb1)().startAngle(Math.PI/2).endAngle(Math.PI/2*3).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",i).attr("transform","translate("+e.cx+","+(e.cy+2)+")")}function l(t){let i=(0,s.Nb1)().startAngle(3*Math.PI/2).endAngle(Math.PI/2*5).innerRadius(7.5).outerRadius(15/2.2);t.append("path").attr("class","mouth").attr("d",i).attr("transform","translate("+e.cx+","+(e.cy+7)+")")}function o(t){t.append("line").attr("class","mouth").attr("stroke",2).attr("x1",e.cx-5).attr("y1",e.cy+7).attr("x2",e.cx+5).attr("y2",e.cy+7).attr("class","mouth").attr("stroke-width","1px").attr("stroke","#666")}return r.append("circle").attr("cx",e.cx-5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),r.append("circle").attr("cx",e.cx+5).attr("cy",e.cy-5).attr("r",1.5).attr("stroke-width",2).attr("fill","#666").attr("stroke","#666"),(0,n.eW)(a,"smile"),(0,n.eW)(l,"sad"),(0,n.eW)(o,"ambivalent"),e.score>3?a(r):e.score<3?l(r):o(r),i},"drawFace"),W=(0,n.eW)(function(t,e){let i=t.append("circle");return i.attr("cx",e.cx),i.attr("cy",e.cy),i.attr("class","actor-"+e.pos),i.attr("fill",e.fill),i.attr("stroke",e.stroke),i.attr("r",e.r),void 0!==i.class&&i.attr("class",i.class),void 0!==e.title&&i.append("title").text(e.title),i},"drawCircle"),$=(0,n.eW)(function(t,e){return(0,r.yU)(t,e)},"drawText"),M=(0,n.eW)(function(t,e,i){let n=t.append("g"),s=(0,r.kc)();s.x=e.x,s.y=e.y,s.fill=e.fill,s.width=i.width*e.taskCount+i.diagramMarginX*(e.taskCount-1),s.height=i.height,s.class="journey-section section-type-"+e.num,s.rx=3,s.ry=3,v(n,s),I(i)(e.text,n,s.x,s.y,s.width,s.height,{class:"journey-section section-type-"+e.num},i,e.colour)},"drawSection"),T=-1,E=(0,n.eW)(function(t,e,i){let n=e.x+i.width/2,s=t.append("g");T++,s.append("line").attr("id","task"+T).attr("x1",n).attr("y1",e.y).attr("x2",n).attr("y2",450).attr("class","task-line").attr("stroke-width","1px").attr("stroke-dasharray","4 2").attr("stroke","#666"),w(s,{cx:n,cy:300+(5-e.score)*30,score:e.score});let a=(0,r.kc)();a.x=e.x,a.y=e.y,a.fill=e.fill,a.width=i.width,a.height=i.height,a.class="task task-type-"+e.num,a.rx=3,a.ry=3,v(s,a);let l=e.x+14;e.people.forEach(t=>{let i=e.actors[t].color;W(s,{cx:l,cy:e.y,r:7,fill:i,stroke:"#000",title:t,pos:e.actors[t].position}),l+=10}),I(i)(e.task,s,a.x,a.y,a.width,a.height,{class:"task"},i,e.colour)},"drawTask"),I=function(){function t(t,e,i,n,s,a,l,o){r(e.append("text").attr("x",i+s/2).attr("y",n+a/2+5).style("font-color",o).style("text-anchor","middle").text(t),l)}function e(t,e,i,n,s,a,l,o,c){let{taskFontSize:h,taskFontFamily:u}=o,y=t.split(/<br\s*\/?>/gi);for(let t=0;t<y.length;t++){let o=t*h-h*(y.length-1)/2,p=e.append("text").attr("x",i+s/2).attr("y",n).attr("fill",c).style("text-anchor","middle").style("font-size",h).style("font-family",u);p.append("tspan").attr("x",i+s/2).attr("dy",o).text(y[t]),p.attr("y",n+a/2).attr("dominant-baseline","central").attr("alignment-baseline","central"),r(p,l)}}function i(t,i,n,s,a,l,o,c){let h=i.append("switch"),u=h.append("foreignObject").attr("x",n).attr("y",s).attr("width",a).attr("height",l).attr("position","fixed").append("xhtml:div").style("display","table").style("height","100%").style("width","100%");u.append("div").attr("class","label").style("display","table-cell").style("text-align","center").style("vertical-align","middle").text(t),e(t,h,n,s,a,l,o,c),r(u,o)}function r(t,e){for(let i in e)i in e&&t.attr(i,e[i])}return(0,n.eW)(t,"byText"),(0,n.eW)(e,"byTspan"),(0,n.eW)(i,"byFo"),(0,n.eW)(r,"_setTextAttrs"),function(r){return"fo"===r.textPlacement?i:"old"===r.textPlacement?t:e}}(),S={drawCircle:W,drawSection:M,drawText:$,drawTask:E,initGraphics:(0,n.eW)(function(t){t.append("defs").append("marker").attr("id","arrowhead").attr("refX",5).attr("refY",2).attr("markerWidth",6).attr("markerHeight",4).attr("orient","auto").append("path").attr("d","M 0,0 V 4 L6,2 Z")},"initGraphics")},A=(0,n.eW)(function(t){Object.keys(t).forEach(function(e){V[e]=t[e]})},"setConf"),P={};function C(t){let e=(0,n.nV)().journey,i=60;Object.keys(P).forEach(r=>{let n=P[r].color,s={cx:20,cy:i,r:7,fill:n,stroke:"#000",pos:P[r].position};S.drawCircle(t,s);let a={x:40,y:i+7,fill:"#666",text:r,textMargin:5|e.boxTextMargin};S.drawText(t,a),i+=20})}(0,n.eW)(C,"drawActorLegend");var V=(0,n.nV)().journey,j=V.leftMargin,N=(0,n.eW)(function(t,e,i,r){let a;let l=(0,n.nV)().journey,o=(0,n.nV)().securityLevel;"sandbox"===o&&(a=(0,s.Ys)("#i"+e));let c="sandbox"===o?(0,s.Ys)(a.nodes()[0].contentDocument.body):(0,s.Ys)("body");D.init();let h=c.select("#"+e);S.initGraphics(h);let u=r.db.getTasks(),y=r.db.getDiagramTitle(),p=r.db.getActors();for(let t in P)delete P[t];let d=0;p.forEach(t=>{P[t]={color:l.actorColours[d%l.actorColours.length],position:d},d++}),C(h),D.insert(0,0,j,50*Object.keys(P).length),B(h,u,0);let f=D.getBounds();y&&h.append("text").text(y).attr("x",j).attr("font-size","4ex").attr("font-weight","bold").attr("y",25);let g=f.stopy-f.starty+2*l.diagramMarginY,x=j+f.stopx+2*l.diagramMarginX;(0,n.v2)(h,g,x,l.useMaxWidth),h.append("line").attr("x1",j).attr("y1",4*l.height).attr("x2",x-j-4).attr("y2",4*l.height).attr("stroke-width",4).attr("stroke","black").attr("marker-end","url(#arrowhead)");let m=y?70:0;h.attr("viewBox",`${f.startx} -25 ${x} ${g+m}`),h.attr("preserveAspectRatio","xMinYMin meet"),h.attr("height",g+m+25)},"draw"),D={data:{startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},verticalPos:0,sequenceItems:[],init:(0,n.eW)(function(){this.sequenceItems=[],this.data={startx:void 0,stopx:void 0,starty:void 0,stopy:void 0},this.verticalPos=0},"init"),updateVal:(0,n.eW)(function(t,e,i,r){void 0===t[e]?t[e]=i:t[e]=r(i,t[e])},"updateVal"),updateBounds:(0,n.eW)(function(t,e,i,r){let s=(0,n.nV)().journey,a=this,l=0;function o(o){return(0,n.eW)(function(n){l++;let c=a.sequenceItems.length-l+1;a.updateVal(n,"starty",e-c*s.boxMargin,Math.min),a.updateVal(n,"stopy",r+c*s.boxMargin,Math.max),a.updateVal(D.data,"startx",t-c*s.boxMargin,Math.min),a.updateVal(D.data,"stopx",i+c*s.boxMargin,Math.max),"activation"!==o&&(a.updateVal(n,"startx",t-c*s.boxMargin,Math.min),a.updateVal(n,"stopx",i+c*s.boxMargin,Math.max),a.updateVal(D.data,"starty",e-c*s.boxMargin,Math.min),a.updateVal(D.data,"stopy",r+c*s.boxMargin,Math.max))},"updateItemBounds")}(0,n.eW)(o,"updateFn"),this.sequenceItems.forEach(o())},"updateBounds"),insert:(0,n.eW)(function(t,e,i,r){let n=Math.min(t,i),s=Math.max(t,i),a=Math.min(e,r),l=Math.max(e,r);this.updateVal(D.data,"startx",n,Math.min),this.updateVal(D.data,"starty",a,Math.min),this.updateVal(D.data,"stopx",s,Math.max),this.updateVal(D.data,"stopy",l,Math.max),this.updateBounds(n,a,s,l)},"insert"),bumpVerticalPos:(0,n.eW)(function(t){this.verticalPos=this.verticalPos+t,this.data.stopy=this.verticalPos},"bumpVerticalPos"),getVerticalPos:(0,n.eW)(function(){return this.verticalPos},"getVerticalPos"),getBounds:(0,n.eW)(function(){return this.data},"getBounds")},O=V.sectionFills,L=V.sectionColours,B=(0,n.eW)(function(t,e,i){let r=(0,n.nV)().journey,s="",a=i+(2*r.height+r.diagramMarginY),l=0,o="#CCC",c="black",h=0;for(let[i,n]of e.entries()){if(s!==n.section){o=O[l%O.length],h=l%O.length,c=L[l%L.length];let a=0,u=n.section;for(let t=i;t<e.length;t++)if(e[t].section==u)a+=1;else break;let y={x:i*r.taskMargin+i*r.width+j,y:50,text:n.section,fill:o,num:h,colour:c,taskCount:a};S.drawSection(t,y,r),s=n.section,l++}let u=n.people.reduce((t,e)=>(P[e]&&(t[e]=P[e]),t),{});n.x=i*r.taskMargin+i*r.width+j,n.y=a,n.width=r.diagramMarginX,n.height=r.diagramMarginY,n.colour=c,n.fill=o,n.num=h,n.actors=u,S.drawTask(t,n,r),D.insert(n.x,n.y,n.x+n.width+r.taskMargin,450)}},"drawTasks"),F={setConf:A,draw:N},R={parser:a,db:_,renderer:F,styles:b,init:(0,n.eW)(t=>{F.setConf(t.journey),_.clear()},"init")}}}]);